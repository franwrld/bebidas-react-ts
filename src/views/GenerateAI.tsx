...
export default function GenerateAI() {
    ...
    return (
      <>
        <h1 className="text-6xl font-extrabold text-cyan-600">Generar Receta con IA</h1>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          {isGenerating && <p className="text-yellow-300 font-bold text-1xl text-center animate-blink">Generando...</p>}
          <div className="py-10 whitespace-pre-wrap">
            <p className="text-white text-1xl">{recipe}</p>
          </div>
        </div>
