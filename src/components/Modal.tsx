        ...
        <>
            <Transition appear show={modal} as={Fragment}>
                ...
                <div className="fixed inset-0 overflow-y-auto">
                    ...
                    >
                        <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-amber-300 px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-2xl sm:p-6" >
